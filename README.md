...
<img src="https://github.com/monkey531/assets/blob/main/274604631-59163c56-55ac-4813-b4aa-b57082e708e6.gif" width="100%" alt="Banner"/>
<img src="https://github.com/monkey531/assets/blob/main/274605183-fd716229-fbd9-46d3-8ccd-3697ffe7e41a.gif" width="100%" alt="marginline"/>

<!-- Typing Title -->
<div align="center">
  <img src="https://readme-typing-svg.demolab.com?lines=Java+Backend+Developer;Spring+Boot+%7C+Spring+Security+%7C+JWT;REST+API+Architect+%7C+Clean+Code+Enthusiast;Cybersecurity+Learner+%7C+Open+Source+Contributor&font=Fira+Code&center=true&width=900&height=45&color=58A6FF&vCenter=true&size=22" />
</div>

<!-- Intro -->
<div align="center">
  <img src="https://github.com/monkey531/assets/blob/main/274605487-3325b60b-6565-45da-ab3e-9d31341c1b5b.gif" width="30" />
  <strong>Hi, I’m Hemanth Kumar M — Java Backend Developer passionate about clean architecture, secure APIs, and automation.</strong>
  <img src="https://github.com/monkey531/assets/blob/main/274605487-3325b60b-6565-45da-ab3e-9d31341c1b5b.gif" width="30" />
</div>
...
- 💻 Specializing in **Spring Boot**, **JWT Security**, and **RESTful APIs**.
- 🔐 Passionate about **DevSecOps**, **CI/CD**, **API Gateway**, and **microservice architectures**.
- 🧰 Focused on building **secure, scalable**, and **maintainable** backend systems.
- 🔭 Currently learning **Prometheus**, **Grafana**, and **Spring Cloud**.
...
### 🔹 [🎯 Order Management System](https://github.com/Hemanth0701/Order-Management-System-UI.git)
- **Stack**: Java, Spring Boot, Vanilla JS  
- ✅ Role-based access (Admin/User), JWT authentication  
- 🛠️ MapStruct, Global Exception Handling, Cron Schedulers

### 🔹 [🎟️ Movie Ticket Booking API](https://github.com/Hemanth0701/movie-ticket-booking-api.git)
- **Stack**: Java 17, Spring Boot, JPA  
- 🔐 Role-based login (User/TheaterOwner), DTO mapping, layered design
